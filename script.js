...
document.addEventListener('DOMContentLoaded', function() {
  ...
  switch (type) {
    ...
    case 'main':
      ...
      bar.innerHTML = `
        <a href="/devlogs/"><img src="/images/ui/spr_devlog_1.png" width="180" onmouseover="changeImage(1,this)" onmouseout="changeImage(2,this)"></a>
        <a href="/demo/"><img src="/images/ui/spr_demo_1.png" width="180" onmouseover="changeImage(3,this)" onmouseout="changeImage(4,this)"></a>
        <a href="/about/"><img src="/images/ui/spr_credits_1.png" width="180" onmouseover="changeImage(5,this)" onmouseout="changeImage(6,this)"></a>
        <a href="https://discord.gg/df3t2DRjaY"><img src="/images/ui/spr_discord_1.png" width="180" onmouseover="changeImage(7,this)" onmouseout="changeImage(8,this)"></a>
      `;
